                    ...
                    <form action="{{ route('registration.store') }}" method="POST" class="p-6 space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="md:col-span-2">
                                ...
                                <x-ui.input name="no_ktp" id="no_ktp" placeholder="Contoh: 32xxxxxxxxxxxxxx" />
                            </div>
                ...
                <x-ui.card class="overflow-hidden">
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-left text-sm">
                            <thead class="bg-white text-slate-500 font-medium border-b border-neutral-200">
                                <tr>
                                    <th class="px-4 py-3 text-xs uppercase tracking-wider">No. Rawat</th>
                                    <th class="px-4 py-3 text-xs uppercase tracking-wider">Nama</th>
                                    <th class="px-4 py-3 text-xs uppercase tracking-wider text-right">Status</th>
                                </tr>
                            </thead>
